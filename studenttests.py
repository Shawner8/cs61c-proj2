...
class TestAbsLoss(TestCase):
    def test_simple(self):
        ...
        t.check_array(output_array, [0, 4, 2, 2, 4, 0, 6, 2, 8])
...
class TestSquaredLoss(TestCase):
    def test_simple(self):
        ...
        t.call("squared_loss")
        # check that the result array contains the correct output
        t.check_array(output_array, [0, 16, 4, 4, 16, 0, 36, 4, 64])
        # check that the register a0 contains the correct output
...
class TestZeroOneLoss(TestCase):
    def test_simple(self):
        ...
        # check that the result array contains the correct output
        t.check_array(output_array, [1, 0, 0, 0, 0, 1, 0, 0, 0])
